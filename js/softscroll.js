...
var SoftScroll = /* 15 Feb 2013 */
{
 ...
 start : function()
 {
   ...
   this.ih( window, 'load', function(){ SoftScroll.init(); } );
 }, 
 ...
 {  
   ...
   this.ih( document, 'click', function( e ){ SoftScroll.getClickedElem( e ) } );
